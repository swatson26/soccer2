...
def create_db_tbls(user,db_pwd):
    ...
    CREATE TABLE games (
                        ...
                        home_max_win_odds numeric,
                        away_max_win_odds numeric,
                        draw_max_win_odds numeric,
                        home_avg_win_odds2 numeric,
                        away_avg_win_odds2 numeric,
                        draw_avg_win_odds2 numeric,
                        home_max_win_odds2 numeric,
                        away_max_win_odds2 numeric,
                        draw_max_win_odds2 numeric,
    					result int,
